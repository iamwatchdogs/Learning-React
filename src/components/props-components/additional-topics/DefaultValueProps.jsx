    ...
    return (
      <>
        <p>
          ...
          through what will happen if we don{"'"}t pass any props or not enough
          to the component?
        </p>
        ...
        <p>
          That{"'"}s great now we can see some value, but what about the
          remaining props?
        </p>
        <p>
  ...
  function MainDescription() {
    return (
      <>
        ...
        <p>
          Well, you can... All you have to do is provided an default value to
          the argument present within the destructring the props in the
          functional component which is going to receive it.
        </p>
      </>
    );
  }
