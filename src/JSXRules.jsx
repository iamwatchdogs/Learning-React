    ...
    return (
        <>
            ...
            <ul className='attributes'>
                ...
                <li>
                    Since attributes like "class" are already part of original
                    Javascript, react uses other attributes idetifiers to
                    represent the actual attribute. for example, for{" "}
                    <code>class</code> attribute, we use <code>className</code>{" "}
                    in React.
                </li>
            </ul>
        </>
    ...
    return (
        <>
            ...
            <ul>
                ...
                <li>
                    Note that while other tags like <code>div</code> group
                    elements within itself as its children, but{" "}
                    <code>React.Fragment</code> group element without setting
    ...
    return (
        <React.Fragment>
            ...
            <ul>
                ...
                <li>
                    Components are the just oridinary functions which return JSX
                    elements, thus you can do your own processing before you
                    return you JSX elements.
                </li>
            </ul>
        </React.Fragment>
    );
