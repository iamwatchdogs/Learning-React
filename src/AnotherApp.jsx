...
function LoremPara2() {
    return (
        <p>
            ...
            velit consectetur aliquid omnis?
        </p>
    );
}
...
function AnotherApp() {
    return (
        <p>
            "LoremPara1" & "LoremPara2" are two components from AnotherApp.js
            file yet can be directly used by other components, as we have
            exported it individually.
        </p>
    );
}
